...
var hideAlert = function hideAlert() {
  ...
  if (el) el.parentElement.removeChild(el); // console.log(el.parentElement);
};
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:3000/api/v1/users/logout' // url: '/api/v1/users/logout',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            'http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe'; // 'http://127.0.0.1:3000/api/v1/tours';
          ...
          case 5:
            ...
            // IF logged in successfuly redirect to the main page after 1500 ms
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updateed successfully!")); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addTour.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editTour = void 0;
...
var editTour = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Tour edited successfully!'); // window.setTimeout(() => {
              //   location.assign('/add-tour');
              // }, 1000);
            }
  ...
  return function editTour(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.editTour = editTour;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"deleteTour.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            console.log(res.data.status); // IF logged in successfuly redirect to the main page after 1500 ms
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmF0ZW1hMTExIiwiYSI6ImNreWc5cTd0NjB3MXYyb3FwOXlyeDhkNWcifQ.pItLbFMFIb82eqJnZMhszw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fatema111/ckygbzw5x1v1x14qizwuua5oh',
...
var stripe = Stripe('pk_test_51KJK1iFpuwy6X2nkjDRYT3G0ES6meYx0eCgRuE8vhW8P1o9hlbxihFzyD4BqBwfqd8azFCffFeeOgs1JMZNHRqDT00mz0cYPAr');
...
var dTour = document.querySelectorAll('.deleteTour');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // this form data to cary the file otherwise the file will not be sent
...
var formHolder = function formHolder(form, method, id) {
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    var form2 = new FormData(); // this form data to cary the file otherwise the file will not be sent
    ...
    form2.append('startLocation[coordinates]', parseInt(document.getElementById('startLocationCoordinates').value.split(',')[1].trim()));
    form2.append('startLocation[address]', document.getElementById('startLocationAddress').value);
...
if (addTourForm) {
  formHolder(addTourForm, _addTour.addTour);
}

if (editTourForm) {
  var id = document.getElementById('edit_id').value;
  formHolder(editTourForm, _updateTour.editTour, id);
}
...
if (dTour) dTour.forEach(function (el) {
